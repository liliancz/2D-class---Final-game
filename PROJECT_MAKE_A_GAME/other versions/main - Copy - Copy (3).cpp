...
void print_buycoins(SDL_Texture *font_texture)
{
	...
	play_text[20] = 0;
	//char tmp[20];
	sprintf(play_text, "A= buy 1000 ", number);
...
int draw_lines(int array[], int number)
{
	...
	int y1 = 150, y2 = 250, y3 = 350, y4 = 450;
	int temp = 0;
	for (int i = 0; i < 16; i++)
	{
		if (i < 4 && number == array[i])
		{
			...
			case 1:
				...
				SDL_RenderDrawLine(Game::renderer, x1, y1, x2, y1);
				printf("1\n");
				temp = i+1;
				break;
			case 2:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x1, y2, x2, y2);
				printf("2\n");
				temp = i+1;
				break;
			...
			case 3:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x1, y3, x2, y3);
				printf("3\n");
				temp = i+1;
				break;
			case 4:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x1, y4, x2, y4);
				printf("4\n");
				temp = i+1;
				break;
			}
		...
		if (temp == 1)
		{
			if (i > 3 && i < 8 && number == array[i])
			{
				...
				case 5:
					SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
					SDL_RenderDrawLine(Game::renderer, x2, y1, x3, y1);
					//printf("1-5\n");
					temp = i + 1;
					break;
				case 6:
					SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
					SDL_RenderDrawLine(Game::renderer, x2, y1, x3, y2);
					//printf("1-6\n");
					temp = i + 1;
					break;
				}
		...
		if (i > 3 && i < 8 && number == array[i] && temp == 2)
		{
			switch (i + 1)
			{
			case 5:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x2, y2, x3, y1);
				//printf("2-5\n");
				temp = i+1;
				break;
			case 6:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x2, y2, x3, y2);
				//printf("2-6\n");
				temp = i+1;
				break;
			case 7:
		...
		if (i > 3 && i < 8 && number == array[i] && temp == 3)
		{
			switch (i + 1)
			{
			case 6:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x2, y3, x3, y2);
				//printf("3-6\n");
				temp = i+1;
				break;
			case 7:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x2, y3, x3, y3);
				//printf("3-7\n");
				temp = i+1;
				break;
			case 8:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x2, y3, x3, y4);
				//printf("3-8\n");
				temp = i+1;
				break;
			}
		...
		if (i > 3 && i < 8 && number == array[i] && temp == 4)
		{
			switch (i + 1)
			{
				case 7:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x2, y4, x3, y3);
				//printf("4-7\n");
				temp = i+1;
				break;
			case 8:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x2, y4, x3, y4);
				//printf("4-8\n");
				temp = i+1;
				break;
			}
		...
		if (temp == 5)
		{
			if (i > 8 && i < 12 && number == array[i])
			{
				...
				case 9:
					SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
					SDL_RenderDrawLine(Game::renderer, x3, y1, x4, y1);
					//printf("5-9\n");
					temp = i + 1;
					break;
				case 10:
					SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
					SDL_RenderDrawLine(Game::renderer, x3, y1, x4, y2);
					//printf("5-10\n");
					temp = i + 1;
					break;
				}
		...
		if (temp == 6)
		{
			if (i > 8 && i < 12 && number == array[i] )
			{
				...
				case 9:
					SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
					SDL_RenderDrawLine(Game::renderer, x3, y2, x4, y1);
					//printf("6-9\n");
					temp = i + 1;
					break;
				case 10:
					SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
					SDL_RenderDrawLine(Game::renderer, x3, y2, x4, y2);
					//printf("6-10\n");
					temp = i + 1;
					break;
				case 11:
					SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
					SDL_RenderDrawLine(Game::renderer, x3, y2, x4, y3);
					//printf("6-11\n");
					temp = i + 1;
					break;
				}
		...
		if (i > 8 && i < 12 && number == array[i] && temp == 7)
		{
			switch (i + 1)
			{
			case 10:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x3, y3, x4, y2);
				//printf("7-10\n");
				temp = i + 1;
				break;
			case 11:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x3, y3, x4, y3);
				//printf("7-11\n");
				temp = i + 1;
				break;
			case 12:
		...
		if (i > 8 && i < 12 && number == array[i] && temp == 8)
		{
			switch (i + 1)
			{
			case 11:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x3, y4, x4, y3);
				//printf("8-11\n");
				temp = i + 1;
				break;
			case 12:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x3, y4, x4, y4);
				//printf("8-12\n");
				temp = i + 1;
				break;
			}
		...
		if (i > 12 && i < 16 && number == array[i] && temp == 9)
		{
			...
			case 13:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x4, y1, x5, y1);
				SDL_RenderDrawLine(Game::renderer, x5, y1, x6, y1);
				//printf("9-13\n");
				temp = i + 1;
				return 200;
				break;
			case 14:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x4, y1, x5, y2);
				SDL_RenderDrawLine(Game::renderer, x5, y2, x6, y2);
				//printf("9-14\n");
				temp = i + 1; 
				return 200;
				break;
		...
		if (i > 12 && i < 16 && number == array[i] && temp == 10)
		{
			switch (i + 1)
			{
			case 13:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x4, y2, x5, y1);
				SDL_RenderDrawLine(Game::renderer, x5, y1, x6, y1);
				printf("WON 100\n");
				temp = i + 1;
				return 200;
			...
			case 14:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x4, y2, x5, y2);
				SDL_RenderDrawLine(Game::renderer, x5, y2, x6, y2);
				printf("Won 100\n");
				temp = i + 1;
				return 200;
			...
			case 15:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x4, y2, x5, y3);
				SDL_RenderDrawLine(Game::renderer, x5, y3, x6, y3);
				printf("Won 100\n");
				temp = i + 1;
				return 200;
				break;
		...
		if (i > 12 && i < 16 && number == array[i] && temp == 11)
		{
			...
			case 14:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x4, y3, x5, y2);
				SDL_RenderDrawLine(Game::renderer, x5, y2, x6, y2);
				printf("won 100\n");
				temp = i + 1;
				return 200;
			...
			case 15:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x4, y3, x5, y3);
				SDL_RenderDrawLine(Game::renderer, x5, y3, x6, y3);
				printf("won 100\n");
				temp = i + 1;
				return 200;
			...
			case 16:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x4, y3, x5, y4);
				SDL_RenderDrawLine(Game::renderer, x5, y4, x6, y4);
				printf("won 100\n");
				temp = i + 1;
				return 200;
				break;
		...
		if (i > 12 && i < 16 && number == array[i] && temp == 12)
		{
			switch (i + 1)
			{
			case 15:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x4, y4, x5, y3);
				SDL_RenderDrawLine(Game::renderer, x5, y3, x6, y3);
				printf("won 100\n");
				temp = i + 1;
				return 200;
			...
			case 16:
				SDL_SetRenderDrawColor(Game::renderer, 255, 0, 255, 255);
				SDL_RenderDrawLine(Game::renderer, x4, y4, x5, y4);
				SDL_RenderDrawLine(Game::renderer, x5, y4, x6, y4);
				printf("won 100\n");
				temp = i + 1;
				return 200;
...
int main(int argc, char **argv)
{
	...
	while (!done)
	{
		...
		// GET MOUSE CLICK
		SDL_PumpEvents();
		// prevoius state create variable
		int pre;
	
	//	pre = g;
			unsigned int g = SDL_GetMouseState(NULL, NULL);
		if ( g & SDL_BUTTON(SDL_BUTTON_LEFT))
		{
			SDL_Log("SPIN");
			pressed = true;
